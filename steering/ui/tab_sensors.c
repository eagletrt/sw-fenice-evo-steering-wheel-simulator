...
void tab_sensors(lv_obj_t *parent) {
  ...
  lv_obj_t *hv_volt_lb = lv_triple_label(
      right_data_panel, &steering.hv.lb_max_cell_voltage[TAB_SENSORS], "X",
  ...
  lv_obj_t *hv_deltaV_lb = lv_triple_label(
      right_data_panel, &steering.hv.lb_min_cell_voltage[TAB_SENSORS], "X",
      &lv_font_inter_bold_38, " V", &lv_font_inter_bold_22, "HV DELTA",
      &lv_font_inter_bold_20);
