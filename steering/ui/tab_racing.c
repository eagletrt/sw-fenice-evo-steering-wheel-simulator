...
void tab_racing(lv_obj_t * parent){
    ...
    lv_obj_set_grid_cell(bar_panel_lv, LV_GRID_ALIGN_CENTER, 0, 1, LV_GRID_ALIGN_CENTER, 0, 1);
    ...
    lv_obj_set_size(right_data_panel, DATA_RIGHT_WIDTH, DATA_PANEL_HEIGHT);
    ...
    lv_obj_set_grid_cell(right_data_panel, LV_GRID_ALIGN_CENTER, 2, 1,
    ...
    lv_obj_set_size(left_data_panel, DATA_LEFT_WIDTH, DATA_PANEL_HEIGHT);
