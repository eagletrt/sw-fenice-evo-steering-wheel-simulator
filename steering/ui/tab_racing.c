...
void tab_racing(lv_obj_t *parent) {
  ...
  lv_obj_set_grid_cell(steering.lv_bar, LV_GRID_ALIGN_CENTER, 0, 1,
  ...
  lv_obj_set_style_bg_color(steering.hv_bar,
                            lv_color_hex(COLOR_ORANGE_STATUS_HEX),
                            LV_PART_INDICATOR);
  lv_obj_set_grid_cell(steering.hv_bar, LV_GRID_ALIGN_CENTER, 0, 1,
  ...
  lv_obj_t *best_time = lv_vertical_pair_label(
      left_data_panel, &steering.steering.lb_best_time[TAB_RACING], " 00:00",
  ...
  lv_obj_t *last_time = lv_vertical_pair_label(
      left_data_panel, &steering.steering.lb_last_time[TAB_RACING], "00:00",
  ...
  lv_obj_t *delta = lv_vertical_pair_label(
      left_data_panel, &steering.steering.lb_delta_time[TAB_RACING], "3.2",
      &lv_font_inter_bold_60, "DELTA", &lv_font_inter_bold_22);
