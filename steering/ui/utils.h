...
static lv_obj_t *lv_triple_label(lv_obj_t *parent, const char *left_text, const lv_font_t *left_text_font , const char *right_text, const lv_font_t *right_text_font, const char *bottom_text, const lv_font_t *bottom_text_font )
{
    ...
    lv_obj_t *up_l = lv_horizontal_pair_label(grid, left_text , left_text_font, right_text , &lv_font_inter_bold_18);
...
static lv_obj_t *create_notch(lv_obj_t *parent){
    ...
    //lv_obj_center(notch_panel);
    lv_obj_set_style_base_dir(notch_panel, LV_BASE_DIR_LTR, 0);
    lv_obj_set_grid_dsc_array(notch_panel, notch_cols, notch_rows);


    // most left item
    lv_bar_t *most_left_bar = lv_bar_create(notch_panel);
    lv_obj_set_size(most_left_bar, NOTCH_BAR_WIDTH_S, NOTCH_BAR_HEIGHT_S);
    lv_obj_set_style_bg_color(most_left_bar, lv_color_hex(COLOR_TERTIARY_HEX), LV_PART_MAIN);
    lv_obj_set_style_bg_opa(most_left_bar, LV_OPA_COVER, LV_PART_MAIN);
    lv_obj_set_style_radius(most_left_bar, 6, LV_PART_MAIN);
    lv_obj_set_grid_cell(most_left_bar, LV_GRID_ALIGN_CENTER, 0, 1, LV_GRID_ALIGN_START, 0, 1);
    ...
    // left item
    lv_bar_t *left = lv_bar_create(notch_panel);
    lv_obj_set_size(left, NOTCH_BAR_WIDTH_S, NOTCH_BAR_HEIGHT_S);
    lv_obj_set_style_bg_color(left, lv_color_hex(COLOR_TERTIARY_HEX), LV_PART_MAIN);
    lv_obj_set_style_bg_opa(left, LV_OPA_COVER, LV_PART_MAIN);
    lv_obj_set_style_radius(left, 4, LV_PART_MAIN);
    ...
    // center item
    lv_bar_t *center = lv_bar_create(notch_panel);
    lv_obj_set_size(center, NOTCH_BAR_WIDTH_L, NOTCH_BAR_HEIGHT_L);
    lv_obj_set_style_bg_color(center, lv_color_hex(COLOR_TERTIARY_HEX), LV_PART_MAIN);
    lv_obj_set_style_bg_opa(center, LV_OPA_COVER, LV_PART_MAIN);
    lv_obj_set_style_radius(center, 9, LV_PART_MAIN);
    ...
    //  right item
    lv_bar_t *right = lv_bar_create(notch_panel);
    lv_obj_set_size(right, NOTCH_BAR_WIDTH_S, NOTCH_BAR_HEIGHT_S);
    lv_obj_set_style_bg_color(right, lv_color_hex(COLOR_TERTIARY_HEX), LV_PART_MAIN);
    lv_obj_set_style_bg_opa(right, LV_OPA_COVER, LV_PART_MAIN);
    lv_obj_set_style_radius(right, 4, LV_PART_MAIN);
    ...
    lv_bar_t *most_right = lv_bar_create(notch_panel);
    lv_obj_set_size(most_right, NOTCH_BAR_WIDTH_S, NOTCH_BAR_HEIGHT_S);
    lv_obj_set_style_bg_color(most_right, lv_color_hex(COLOR_TERTIARY_HEX), LV_PART_MAIN);
    lv_obj_set_style_bg_opa(most_right, LV_OPA_COVER, LV_PART_MAIN);
    lv_obj_set_style_radius(most_right, 4, LV_PART_MAIN);
